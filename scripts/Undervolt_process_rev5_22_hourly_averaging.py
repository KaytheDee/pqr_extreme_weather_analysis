...
cleaned_flags_bounds = pd.read_csv(
    '/work/pi_jtaneja_umass_edu/kdonkor_umass_edu/Geospatial_Files/Undervoltage_Analysis/undervolt_cleaned_flags_all_22_rev5.csv',
    low_memory=False
)
...
## Save to file 
hourly_voltages_df.to_csv('/work/pi_jtaneja_umass_edu/kdonkor_umass_edu/Geospatial_Files/Undervoltage_Analysis/undervolt_hourly_voltages_df_22.csv', index=False)
